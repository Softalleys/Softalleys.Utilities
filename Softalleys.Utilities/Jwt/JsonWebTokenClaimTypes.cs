...
/// <summary>
/// List of standard claim types used in JSON Web Tokens (JWT).
/// </summary>
...

{
    ...
    /// </summary>
    /// <remarks>
    ///     Defined in RFC 7519, Section 4.1.3. It is generally a case-sensitive string or an array of strings containing
    ///     StringOrURI values.
    ...
    /// </summary>
    /// <remarks>
    ///     Defined in RFC 7519, Section 4.1.4. The "exp" claim is a NumericDate value. Use this claim to define the validity
    ///     period of the JWT.
    /// </remarks>
    ...
    ///     It ensures that the authorization code is bound to the ID Token, enhancing the security of the code exchange
    ///     process.
    /// </remarks>
    ...
    /// <summary>
    ///     Represents the tenant ID claim, which is used to identify the tenant or organization that the user belongs to.
    /// </summary>
    public const string TenantId = Tid;

    /// <summary>
    ///     The standard claim type for tenant ID.
    /// </summary>
    public const string Tid = "tid";

    /// <summary>
    /// Represents the tenant identifier used to uniquely identify a tenant or organization.
    /// </summary>
    public const string TenantIdentifier = "tenant_identifier";

    /// <summary>
    /// Represents the common name of the tenant, often used for display or identification purposes.
    /// </summary>
    public const string TenantCommonName = "tenant_common_name";
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect for representing the user's full name in a single string. It might include the first,
    ///     middle, last, and other names.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim is intended to refer to the user's first name or given name(s). It allows for
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim is intended for the user's middle name(s), which might not be present for all
    ///     users.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim is for the user's casual or informal name that might differ from their legal
    ///     name.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     This claim is used to convey the user's username within the system. It allows the user to specify a username
    ///     It is used to uniquely identify the user within the system, facilitating user management and access control.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim is for the user's preferred email. Note that this email address might not be
    ///     unique.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim can be used to convey the user's gender. The value is not strictly defined and
    ///     can vary based on the user's preference and the application's requirements.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim is for the user's birthdate, typically represented in the ISO 8601:2004
    ///     YYYY-MM-DD format.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim specifies the user's preferred language and optionally, region. Typically
    ///     represented as a language tag, e.g., en-US or fr-CA.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim provides the user's preferred phone number. The format of the number can vary
    ///     and it's not guaranteed to be in a standard format.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This JSON structured claim contains components of the user's address such as street
    ///     address, locality, region, postal code, and country.
    /// </remarks>
    public const string Address = "address";


    /// <summary>
    /// Represents the contact address claim used within JSON Web Tokens (JWT).
    /// </summary>
    /// <remarks>
    /// This constant is used to identify the claim that holds a contact address,
    /// allowing applications to convey contact information in a standardized way.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim provides a Unix time stamp indicating when the user's information was last
    ///     updated.
    /// </remarks>
    public const string UpdatedAt = "updated_at";

    /// <summary>
    ///     Indicates when the user's information was created.
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim provides a Unix time stamp indicating when the user's information was last
    ///     updated.
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim is particularly useful in delegated scenarios to identify the party using the ID
    ///     Token.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Used in OpenID Connect. This claim is used to specify the authentication methods used in the authentication
    ///     process.
    ...
    /// <summary>
    ///     "sip_cseq_num" - Numeric value from the SIP 'CSeq' header field, indicating the command sequence number in SIP
    ///     protocol.
    /// </summary>
    ...
    /// <summary>
    /// Custom claims are application-specific claims that can be defined by the application developers.
    /// </summary>
