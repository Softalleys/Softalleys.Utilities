...
public static class JsonWebTokenExtensions
{
    ...
    /// <param name="value">
    ///     The <see cref="DateTimeOffset" /> value to set. If <c>null</c>,
    ...
    /// <summary>
    ///     Sets a property in a <see cref="JsonObject" /> with a value that can be either a single string or an array of
    ///     strings,
    ...
    /// <summary>
    ///     Converts a collection of strings to a JSON node, which will be either a single JSON value if there's only one
    ///     string,
    ///     or a JSON array if there are multiple strings.
    /// </summary>
    /// <param name="values">The collection of strings to convert.</param>
    /// <returns>
    ///     A <see cref="JsonNode" /> representing either a single value or an array of strings, or null if the collection
    ///     is empty.
    /// </returns>
    ...
    /// <summary>
    ///     Sets a property in a <see cref="JsonObject" /> with a value represented as a space-separated string from an
    ...
    /// <returns>The modified <see cref="JsonObject" />.</returns>
    /// <remarks>
    ///     This method is useful for setting JWT claims or other JSON properties that accept a list of values as a single
    ...
    /// </remarks>
    public static DateTime? CheckDateOverflow(this DateTimeOffset? dateTime, string name)
    {
